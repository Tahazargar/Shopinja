                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>38</td>
                            <td>22</td>
                            <td class="width-22-rem text-left d-flex justify-content-end gap-1">
                                <a href="{{ route('store.add-to-store') }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> افزایش موجودی</a>
